import { Dialog, DialogContent, DialogTitle, Card, CardHeader, Stack, Item, Typography } from "@mui/material";
...
export default function BoxSummary({ id, open, setOpen }) {
	...
	return (
		<Dialog
			...
			scroll='body'
			keepMounted={false}>
			<DialogTitle>Box summary</DialogTitle>
			<DialogContent>
				<Card>
					<CardHeader title='Informations' />
					<Stack direction={'row'} spacing={5} padding={3} alignItems={'flex-start'}>
