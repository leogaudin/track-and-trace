...
export default function Globe() {
  ...
  useEffect(() => {
    ...
    const globe = createGlobe(canvasRef.current, {
      ...
      markerColor: [0.46, 0.42, 0.99],
      glowColor: [0.16, 0.12, 0.69],
      markers: [
		{ location: [40.516314385683806, -3.664187832967221], size: 0.01 },
		...
		{ location: [45.783463154986734, 4.746984468248205], size: 0.01 },
		{ location: [40.191854267103814, 44.47936076854719], size: 0.02 },
		{ location: [-34.92804017283984, 138.59738552603034], size: 0.01 },
		{ location: [48.248455059959895, 16.36840289771301], size: 0.03 },
		{ location: [50.845409346017895, 4.357378497829092], size: 0.02 },
		{ location: [51.21263932653407, 4.4233200956481316], size: 0.01 },
		{ location: [-23.557369134698845, -46.68949310000001], size: 0.01 },
		{ location: [-22.893709591733252, -43.19670947011024], size: 0.02 },
		{ location: [46.812047157251605, -71.2238417], size: 0.03 },
		{ location: [50.11104389110869, 14.517540568959923], size: 0.01 },
		{ location: [60.180776092402965, 24.958245062878174], size: 0.01 },
		{ location: [45.655206000816726, 0.15895312883586085], size: 0.02 },
		{ location: [49.48977747142472, 0.12549336893201676], size: 0.03 },
		{ location: [47.738421586520516, 7.3274942265265395], size: 0.01 },
		{ location: [43.68347561236782, 7.202513997520135], size: 0.01 },
		{ location: [42.69843003647246, 2.8884202551522], size: 0.01 },
