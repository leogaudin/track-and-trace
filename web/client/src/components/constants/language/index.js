		...
		resources: {
			en: {
				translation: {
					...
					minuteFromNow: 'in {{minute}} minutes',
					hourAgo: '{{hour}} hours ago',
					hourFromNow: 'in {{hour}} hours',
					lastWeek: 'Last week',
					nextWeek: 'Next week',
			...
			fr: {
				translation: {
					...
					minuteFromNow: 'dans {{minute}} minutes',
			...
			es: {
				translation: {
					...
					minuteAgo: 'Hace {{minute}} minutos',
					minuteFromNow: 'en {{minute}} minutos',
					hourAgo: 'Hace {{hour}} horas',
					hourFromNow: 'en {{hour}} horas',
			...
			de: {
				translation: {
					...
					minuteAgo: 'Vor {{minute}} Minuten',
					minuteFromNow: 'in {{minute}} Minuten',
					hourAgo: 'Vor {{hour}} Stunden',
					hourFromNow: 'in {{hour}} Stunden',
